...
async function WelcomePage() {
  return (
    <div className="flex w-full flex-1 items-center justify-center px-4">
      <BackgroundPattern className="absolute inset-0 left-1/2 top-1/2 z-0 -translate-x-1/2 -translate-y-1/2 opacity-75" />
      <div className="relative z-10 flex -translate-y-1/2 flex-col items-center gap-6 text-center">
        ...
        <p className="max-w-prose text-base/7 text-muted-foreground">
